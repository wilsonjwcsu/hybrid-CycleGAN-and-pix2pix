...
class CycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.usePairedL1Loss:
            self.loss_names = ['D_A', 'G_A', 'cycle_A', 'idt_A', 'D_B', 'G_B', 'cycle_B', 'idt_B', 'L1_A', 'L1_B']
        else:
	...
	# paired image L1 losses
        if self.usePairedL1Loss:
            self.loss_L1_A = self.criterionL1(self.real_B, self.fake_B) * lambda_L1
            self.loss_L1_B = self.criterionL1(self.real_A, self.fake_A) * lambda_L1
